class Grimper extends Phaser.Scene {
    ...
    create ()
    {
        ...
        this.lianne.setTintFill();
        this.lianne.setDisplaySize(6,345);
        this.lianne.body.setAllowGravity(false);
        this.lianne.setImmovable(true);
...
//CREATION D'UN GROUPE POUR LA REPETITION D'UN OBJET
        ...
        platforms.create(600, 400, 'ground').setScale(1,13).refreshBody();
