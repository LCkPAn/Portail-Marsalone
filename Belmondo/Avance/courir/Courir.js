class Courir extends Phaser.Scene {
        ...
        this.input.keyboard.on('keydown', function (kevent) {
            switch (kevent.keyCode) {
                case Phaser.Input.Keyboard.KeyCodes.SHIFT:
                    if (me.leftDown){
                        player.setVelocityX(-260);//LE PERSONNAGE VA A UNE VITESSE DE <A UNE VITESSE DE 260 A GAUCHE
                    }
                    else if (me.rightDown){
                        player.setVelocityX(260);//LE PERSONNAGE VA A UNE VITESSE DE A UNE VITESSE DE 260 A DROITE
                    }
                    break;
